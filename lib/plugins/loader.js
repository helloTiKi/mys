...
global.smStringify = function (param_1, param_2) {
  "use strict";
  var n = ["number", "boolean", "undefined", "string", "function"];
  function o(e) {
    var t = void 0 === e ? "undefined" : typeof e;
    return "string" == t || "function" == t ? '"' + e.toString().replace('"', '\\"') + '"' : "number" == t || "boolean" == t ? e.toString() : "undefined" == t ? "undefined" : '"' + e.toString().replace('"', '\\"') + '"'
  }
  function c(e, t) {
  ...
  var i = function e(t) {
    var i = void 0 === t ? "undefined" : typeof t;
    if (c(n, i) > -1)
      return o(t);
    if (t instanceof Array) {
      for (var a = t.length, s = [], d = 0; d < a; d++) {
        var l = typeof t[d];
        c(n, l) > -1 ? "undefined" != l ? s.push(o(t[d])) : s.push("null") : s.push(e(t[d]))
      }
      return "[" + s.join(",") + "]"
    }
    if (t instanceof Object) {
      ...
      for (var u in t) {
        var l = typeof t[u];
        c(n, l) > -1 ? "undefined" != l && s.push('"' + u + '":' + o(t[u])) : s.push('"' + u + '":' + e(t[u]))
      }
      return "{" + s.join(",") + "}"
    }
  }(param_1);
  if (param_2) {
    for (var a = "", s = 0; s < i.length; s++)
      i.charCodeAt(s) < 255 ? a += i[s] : a += "\\u" + i.charCodeAt(s).toString(16);
    i = a
  }
...
class PluginsLoader {
  ...
  packageTips(packageErr) {
    ...
    packageErr.forEach(v => {
      ...
      logger.mark(`新增插件后请执行安装命令：${logger.red('pnpm install -P')} 安装依赖`)//logger.mark(`如安装后仍未解决可联系插件作者将 ${logger.red(pack)} 依赖添加至插件的package.json dependencies中，或手工安装依赖`)
    })
  ...
  getPlugins() {
    ...
    for (let val of files) {
      ...
      console.log(val.name, `${this.dir}/${val.name}/index.js`);
  ...
  async deal(e) {
    ...
    //logger.mark(smStringify(priority))
