...
export default class MysUser extends BaseModel {
  ...
  static async getGameRole(ck, serv = 'mys') {
    let url = {
      all: 'https://api-takumi.mihoyo.com/binding/api/getUserGameRolesByCookie',
      ...
      luna: 'https://api-os-takumi.mihoyo.com/binding/api/getUserGameRolesByCookie?game_biz=hkrpg_cn'
    }
